...
const services = [
  {
    image:
      "/projects/field-work-and-system-integration/image-02.jpeg",
    icon: Home,
  ...
  {
    image:
      "/projects/fg-12-15kw/image-01.jpeg",
    icon: Building2,
  ...
  {
    image:
      "/projects/ps-05-building-1-15kw/image-01.jpeg",
    icon: Wrench,
...
function ServiceCard({ service, index }) {
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -6 }}
      className="service-card relative rounded-2xl overflow-hidden shadow-lg shadow-slate-300/50"
    >
      <div className="relative h-64 md:h-72 w-full overflow-hidden">
        ...
        <motion.div
          ...
          transition={{ duration: 0.45, ease: [0.22, 1, 0.36, 1] }}
          className="service-card__overlay absolute bottom-0 left-0 w-full bg-slate-950/90 backdrop-blur-sm px-5 pt-4 pb-4 flex flex-col overflow-hidden"
        >
          ...
          <motion.p
            ...
            className="service-card__description text-white/85 text-xs md:text-sm leading-relaxed mt-3"
          >
            {service.description}
          </motion.p>
          ...
          <motion.a
            ...
            className="service-card__link mt-auto pt-3 flex items-center gap-1.5 text-[#4ade80] text-xs md:text-sm font-bold tracking-wide"
          >
            Read More
            <ArrowRight size={14} />
          </motion.a>
      ...
      <div className="site-container relative z-10">
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="tap-target responsive-cta relative overflow-hidden flex items-center justify-center gap-2 px-9 py-4 rounded-full font-bold text-white text-sm md:text-base bg-gradient-to-r from-[#16a34a] to-[#22c55e] shadow-xl shadow-green-500/40"
          >
            <motion.span
