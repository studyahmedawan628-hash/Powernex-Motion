...
function AnimatedLine({ text, className }) {
  return (
    <motion.span
      className={`${className} block whitespace-nowrap`}
...
export default function TrustSection() {
  return (
    <section className="relative bg-gradient-to-br from-slate-50 via-blue-50/50 to-slate-50 min-h-screen w-full overflow-hidden py-24 md:py-0 flex items-center">
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-8 md:px-12 grid md:grid-cols-2 gap-10 md:gap-16 items-center">
        {/* Left - text */}
        <div>
          <motion.div
          ...
          <motion.p
            ...
            className="text-slate-600 text-base leading-relaxed mb-8 max-w-sm"
          >
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="relative overflow-hidden px-7 py-3.5 rounded-full font-semibold text-white bg-gradient-to-r from-[#16a34a] to-[#22c55e] shadow-lg shadow-green-500/40"
            >
              <motion.span
        ...
        >
          <div className="absolute -top-4 -right-4 w-full h-full border-2 border-[#22c55e]/40 rounded-3xl -z-10" />
