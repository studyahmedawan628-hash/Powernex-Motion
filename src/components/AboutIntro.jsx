...
import { ShieldCheck, Link2, FileText, Leaf } from "lucide-react";
...
export default function AboutIntro() {
  return (
    <section className="relative w-full overflow-hidden bg-white">
      <div className="about-intro__grid relative grid lg:grid-cols-2">
        {/* ============ LEFT SIDE ============ */}
        <div className="relative z-10 flex flex-col justify-center site-gutter py-16 order-2 lg:order-1">
          ...
          >
            ...
            <h2 className="page-title font-extrabold uppercase leading-[1.08] text-[#0f172a] tracking-tight">
              Powering Pakistan's
              <br />
            ...
            <p className="text-slate-600 text-sm md:text-base leading-relaxed max-w-md">
              {BRAND.name} is a leading solar energy company
            ...
            <div className="mt-8 flex flex-col gap-2.5 max-w-lg">
              {highlights.map(({ icon: Icon, title, desc }, i) => (
                <motion.div
                  ...
                  whileHover={{ x: 4 }}
                  className="about-highlight relative flex items-stretch rounded-r-2xl overflow-hidden shadow-md shadow-slate-300/40"
                >
                  <div className="flex items-center justify-center w-14 shrink-0 bg-[#16a34a]">
                    <Icon size={20} className="text-white" />
                  </div>
                  <div className="about-highlight__content flex-1 flex items-center gap-4 bg-[#101a2b] pl-5 pr-6 py-3.5">
        ...
        <div className="about-intro__visual relative overflow-hidden bg-[#0a1220] order-1 lg:order-2 min-h-[380px] flex items-center justify-center">
          ...
          >
            <div className="w-full h-full bg-white p-2 md:p-2.5 rounded-md shadow-2xl shadow-black/50">
              <img
                src="/projects/field-work-and-system-integration/image-02.jpeg"
          ...
          {/* Official brand mark - bottom right */}
          <motion.div
          ...
          >
            <img
              ...
              alt={BRAND.name}
              className="h-auto w-[clamp(8rem,12vw,11rem)] object-contain"
            />
          </motion.div>
        </div>
      </div>
