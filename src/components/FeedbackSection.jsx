    ...
    <section className="relative w-full overflow-hidden bg-slate-50 py-24">
      <div className="site-container relative z-10">
        <div className="grid md:grid-cols-2 gap-14 md:gap-10 items-center">
          ...
          <div className="feedback-stats relative h-[420px] md:h-[500px] flex items-center justify-center md:justify-start">
            ...
            <motion.div
              ...
              className="feedback-stat feedback-stat--large absolute bottom-0 left-1/2 md:left-4 -translate-x-1/2 md:translate-x-0 h-[340px] w-[340px] md:h-[380px] md:w-[380px] rounded-full bg-gradient-to-br from-white to-[#eefbf1] shadow-xl shadow-green-900/5 border border-green-100 flex flex-col items-center justify-center text-center px-10"
            >
            ...
            <motion.div
              ...
              className="feedback-stat feedback-stat--small absolute top-0 right-1/2 md:right-4 translate-x-1/2 md:translate-x-0 h-[220px] w-[220px] md:h-[250px] md:w-[250px] rounded-full bg-gradient-to-br from-white to-[#eefbf1] shadow-xl shadow-green-900/5 border border-green-100 flex flex-col items-center justify-center text-center px-6"
            >
          ...
          <motion.div
            ...
            className="feedback-form bg-white rounded-3xl shadow-xl shadow-slate-300/40 border border-slate-100 p-8 md:p-10"
          >
            ...
            <form className="space-y-5">
              ...
              <div>
                ...
                <textarea
                  rows={4}
                  placeholder={`Tell us about your experience with ${BRAND.name}...`}
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.96 }}
                className="tap-target responsive-cta relative overflow-hidden px-7 py-3 rounded-xl font-bold text-white text-sm bg-gradient-to-r from-[#16a34a] to-[#22c55e] shadow-lg shadow-green-500/30"
              >
                <motion.span
