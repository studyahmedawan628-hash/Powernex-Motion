  ...
  return (
    <section className="relative w-full overflow-hidden py-24 md:py-32">
      ...
      <div className="absolute inset-0">
        <img
          src="src/assets/solar-acheivement.png"
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 md:px-12">
        ...
        <div className="relative flex items-end justify-center gap-4 md:gap-8 pb-6">
          ...
          {stats.map((stat, i) => {
            ...
            return (
              <motion.div
                ...
                className={`relative z-10 ${stat.height} w-24 md:w-40 flex flex-col items-center justify-start gap-4 pt-7 md:pt-8 px-3 rounded-t-2xl rounded-b-sm overflow-hidden bg-gradient-to-b from-[#16324a] to-[#0a1826] border border-white/10 border-t-2 border-t-[#22c55e]/80 shadow-[0_10px_25px_-5px_rgba(0,0,0,0.6)]`}
              >
