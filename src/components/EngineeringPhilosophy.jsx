...
export default function EngineeringPhilosophy() {
  return (
    <section className="relative w-full overflow-hidden bg-white py-24">
      ...
      <div className="site-container relative z-10 grid lg:grid-cols-2 gap-16 lg:gap-14 items-center">
        ...
        <div>
          ...
          <div className="engineering-steps flex items-start mt-14">
            {steps.map((step, i) => (
              <div key={step.title} className="engineering-step flex items-center flex-1 last:flex-none">
                <motion.div
                ...
                {i < steps.length - 1 && (
                  <div className="engineering-connector relative z-0 flex-1 h-[2px] -ml-8 -mr-8 md:-ml-9 md:-mr-9 mt-8 md:mt-9">
                    <motion.span
                      initial={{ scaleX: 0 }}
