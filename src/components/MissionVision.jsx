            ...
            <div className="site-container relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <motion.div
                        ...
                        className="purpose-card rounded-2xl overflow-hidden shadow-xl bg-white flex flex-col"
                    >
                        <div
                            className="purpose-card__hero relative flex flex-col justify-end p-8"
                            style={{
                                backgroundImage:
                                    "url('/projects/field-work-and-system-integration/image-04.jpeg')",
                        ...
                        {/* stats bar */}
                        <div className="purpose-stats bg-[#0b1324] grid grid-cols-3 divide-x divide-white/10 px-4 py-8">
                    ...
                    <motion.div
                        ...
                        whileInView="visible"
                        viewport={{ once: true, amount: 0.2 }}
                        className="purpose-card rounded-2xl overflow-hidden shadow-xl bg-[#0b1324] flex flex-col"
                    >
                        <div
                            className="purpose-card__hero relative flex flex-col justify-end p-8"
                            style={{
                                backgroundImage:
                                    "url('/projects/field-work-and-system-integration/image-11.jpeg')",
                                backgroundSize: "cover",
                                backgroundPosition: "center",
                            }}
                        >
                        ...
                        {/* stats bar */}
                        <div className="purpose-stats bg-[#0b1324] grid grid-cols-3 divide-x divide-white/10 px-4 py-8 border-t border-white/5">
