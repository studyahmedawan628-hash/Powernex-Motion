...
const testimonials = [
  {
    ...
    quote:
      "I was hesitant at first but PowerNex made the whole process seamless. Their team is knowledgeable and the installation is top-notch.",
  },
  {
    name: "Ali Hassan",
    location: "Lahore",
  ...
  },
  {
    ...
    quote:
      "PowerNex transformed our home with a solar solution. The installation was quick and very professional throughout the process.",
  },
  {
    name: "Bilal Ahmed",
    location: "Karachi",
    ...
    <section className="relative w-full overflow-hidden bg-gradient-to-b from-[#eefbf1] via-[#f3fbf5] to-[#eefbf1] py-24">
      ...
      >
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="relative overflow-hidden px-8 py-3.5 rounded-full font-bold text-white text-sm md:text-base bg-gradient-to-r from-[#16a34a] to-[#22c55e] shadow-xl shadow-green-500/40"
        >
          <motion.span
